...
window.addEventListener("scroll", () => {
  if (scrollY > 100) {
    ...
    document.querySelector(".nav-header").style.borderRadius = "15px";
    document.querySelector(".nav-header").style.marginTop = "20px";
    document.querySelector(".nav-header").style.boxShadow = "2px 2px 10px #00000026";
  }
  if (scrollY < 100) {
    document.querySelector(".quickbar").style.display = "flex";
    document.querySelector(".nav-header").style.backgroundColor = "";
    document.querySelector(".nav-header").style.borderRadius = "";
    document.querySelector(".nav-header").style.marginTop = "";
    document.querySelector(".nav-header").style.boxShadow = "";
  }
});
